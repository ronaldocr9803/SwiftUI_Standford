...
[Video](https://www.youtube.com/watch?v=bqu6BquVi2M&list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&index=1)

[Slides](./documents/Slides/l1.pdf)

-Notes:
    - ZStack – arranges things from back to front, which in content property,it takes an function as argument

## Lecture 2: MVVM and the Swift Type System
Notes:
- All views in SwiftUI is immutable, can not be modified
[Video](https://youtu.be/4GjXq2Sr55Q)
-   [Making multiple cards] (https://youtu.be/3lahkdHEhW8?list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&t=41)
-   [Control Preview View](https://youtu.be/3lahkdHEhW8?list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&t=463)
    - create multiple previews (ex: dark and light mode previews)
-   [Tap gesture on view](https://youtu.be/3lahkdHEhW8?list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&t=1393)
-   [Review everything leanred so far](https://youtu.be/3lahkdHEhW8?list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&t=3676)
    - building structure behave like a view: 
    - UI portion is all functional programming
    - put Views together to build complicated user interfaces
-   [LazyVGrid](https://youtu.be/3lahkdHEhW8?list=PLpGHT1n4-mAsxuRxVPv7kj4-dQYoC3VVu&t=4206)
    - has columns property which not an int. Instead is GridItem, because it allow you to control columns more like: set width for column,
